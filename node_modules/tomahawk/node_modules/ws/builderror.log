...
gyp info using node@24.19.0 | win32 | x64
gyp info find Python using Python version 3.13.14 found at "C:\Users\dasma\AppData\Local\Programs\Python\Python313\python3.13t.exe"
...
gyp http GET https://nodejs.org/download/release/v24.19.0/win-x64/node.lib
gyp http 200 https://nodejs.org/download/release/v24.19.0/SHASUMS256.txt
gyp http 200 https://nodejs.org/download/release/v24.19.0/win-x64/node.lib
gyp ERR! find VS 
...
gyp ERR! stack at process.processTicksAndRejections (node:internal/process/task_queues:104:5)
...
gyp ERR! cwd C:\Users\dasma\OneDrive\Desktop\Live Projects\Ephorsys\Binaayak Industries\backend\node_modules\tomahawk\node_modules\ws
gyp ERR! node -v v24.19.0
gyp ERR! node-gyp -v v12.4.0
gyp ERR! $npm_package_name ws
gyp ERR! $npm_package_version 0.4.31
gyp ERR! not ok 
